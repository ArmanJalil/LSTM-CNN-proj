...
# SINGLE TARGET
target_col = 'Veldan_CO(ppm)'
target_cols = [target_col]

# Include target column in features for auto-correlation
feature_cols = df.columns[[16, 22, 57, 31, 37, 45,66,67,68,69,70,71,72,73,74,75,76]].tolist()#[c for c in df.columns if c not in ['Date']]
...
# Plot 3: Time series comparison WITH DATES
...
# Plot 4: Last 100 samples WITH DATES
...
ax4.set_title('Last 100 Samples - Correct Time Alignment')
ax4.legend()
